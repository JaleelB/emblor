...
<Table>
  ...
  <TableBody>
    ...
    <TableRow>
      <TableCell className="border-r">includeTagsInInput</TableCell>
      <TableCell className="border-r">false</TableCell>
      <TableCell className="border-r">boolean</TableCell>
      <TableCell className="border-r">If true, renders the tags inline in the input field.</TableCell>
      <TableCell>No</TableCell>
    </TableRow>
    <TableRow>
    ...
    <TableRow>
      ...
      <TableCell className="border-r">Sets the direction of the tag input.</TableCell>
      <TableCell>No</TableCell>
    </TableRow>
    <TableRow>
    ...
    <TableRow>
      ...
      <TableCell className="border-r">"top" | "bottom" | "inline"</TableCell>
      <TableCell className="border-r">Sets the position of the input field.</TableCell>
      <TableCell>No</TableCell>
    </TableRow>
    <TableRow>
